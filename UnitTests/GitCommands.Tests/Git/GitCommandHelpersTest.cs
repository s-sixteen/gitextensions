...
namespace GitCommandsTests.Git
{
    ...
    public class GitCommandsHelperTest
    {
        ...
        [Test]
        public void TestGetStagedStatus()
        {
            var headObjectId = ObjectId.Random();

            DoTest(ObjectId.IndexId, ObjectId.WorkTreeId, ObjectId.IndexId, StagedStatus.WorkTree);

            DoTest(headObjectId, ObjectId.IndexId, headObjectId, StagedStatus.Index);

            DoTest(ObjectId.Random(), ObjectId.Random(), ObjectId.Random(), StagedStatus.None);
            DoTest(ObjectId.Random(), ObjectId.Random(), null, StagedStatus.None);

            // Asserts when IsStaged is used
            DoTest(ObjectId.WorkTreeId, ObjectId.Random(), ObjectId.Random(), StagedStatus.Unknown);
            DoTest(ObjectId.Random(), ObjectId.WorkTreeId, ObjectId.IndexId, StagedStatus.Unknown);
            DoTest(ObjectId.IndexId, ObjectId.Random(), ObjectId.Random(), StagedStatus.Unknown);
            DoTest(ObjectId.Random(), ObjectId.IndexId, ObjectId.Random(), StagedStatus.Unknown);
            DoTest(ObjectId.Random(), null, ObjectId.Random(), StagedStatus.Unknown);
            DoTest(null, ObjectId.Random(), ObjectId.Random(), StagedStatus.Unknown);

            // Impossible combinations
            DoTest(ObjectId.Random(), ObjectId.WorkTreeId, ObjectId.Random(), StagedStatus.Unknown);
            DoTest(ObjectId.Random(), ObjectId.Random(), ObjectId.WorkTreeId, StagedStatus.None);
            DoTest(ObjectId.Random(), ObjectId.IndexId, ObjectId.WorkTreeId, StagedStatus.Unknown);
            DoTest(headObjectId, ObjectId.WorkTreeId, headObjectId, StagedStatus.Unknown);
            DoTest(ObjectId.Random(), ObjectId.Random(), ObjectId.IndexId, StagedStatus.None);

            return;

            void DoTest(ObjectId firstRevision, ObjectId secondRevision, ObjectId parentToSecond, StagedStatus status)
            {
